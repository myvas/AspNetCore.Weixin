...
namespace Myvas.AspNetCore.Weixin
{
    ...
    public class AccessTokenBag
    {
        ...
        /// 微信全局访问凭证数据。通过调用接口获得。
        /// </summary>
        public AccessTokenJson AccessTokenJson = new AccessTokenJson();
        ...
        {
            get { return CreateTime.AddSeconds(AccessTokenJson.expires_in); }
            set { CreateTime = value.AddSeconds(-AccessTokenJson.expires_in); }
        }
