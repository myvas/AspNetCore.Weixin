...
namespace Myvas.AspNetCore.Weixin
{
    public static class MenuApi
    {
        ...
        /// <returns></returns>
        public static async Task<WeixinErrorJson> CreateMenu(string accessToken, ButtonGroup buttonData)
        {
        ...
        /// <param name="buttonData">菜单内容</param>
        /// <returns></returns>
        public static async Task<WeixinErrorJson> CreateMenuAsync(string accessToken, string menuJson)
        {
            var api = "https://api.weixin.qq.com/cgi-bin/menu/create?access_token={0}";
            api = string.Format(api, accessToken);
        ...
        private static ClickMenuButton GetSingleButtonFromJsonObject(Dictionary<string, object> objs)
        {
        ...
        public static GetMenuResult GetMenuFromJson(string json)
        {
        ...
        /// <param name="accessToken"></param>
        /// <returns></returns>
        public static async Task<WeixinErrorJson> DeleteMenu(string accessToken)
        {
