...
public interface ISubscriptionNotification
{
    ...
    /// <returns></returns>
    Task SubscribeAsync(IEnumerable<Subscriber> subscribers, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token</param>
    /// <returns></returns>
    Task UnsubscribeAsync(IEnumerable<Subscriber> subscribers, CancellationToken cancellationToken = default);
}