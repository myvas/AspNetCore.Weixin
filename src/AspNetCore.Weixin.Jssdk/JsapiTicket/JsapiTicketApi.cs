...
namespace AspNetCore.Weixin
{
    ...
    /// 获取微信凭证数据服务接口
    /// </summary>
    internal static class JsapiTicketApi
    {
        /// <summary>
        ...
        /// </exception>
        public static async Task<JsapiTicketJson> GetJsapiTicket(string access_token)
        {
            ...
            var result = await HttpUtility.GetJson<JsapiTicketJson>(api);
            if (result.Succeeded)
                return result;
            else
