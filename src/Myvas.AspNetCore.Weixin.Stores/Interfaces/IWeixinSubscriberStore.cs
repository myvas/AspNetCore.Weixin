...
namespace Myvas.AspNetCore.Weixin
{
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        Task AddAssociationAsync(TWeixinSubscriber subscriber, TKey userId, CancellationToken cancellationToken);
        Task RemoveAssociationAsync(TWeixinSubscriber subscriber, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>A <see cref="Task{TResult}"/> that result of the look up.</returns>
        Task<TWeixinSubscriber> FindByUserIdAsync(TKey userId, CancellationToken cancellationToken);

        Task<IList<TWeixinSubscriber>> GetItemsByMentorIdAsync(TKey mentorId, int perPage, int pageIndex, CancellationToken cancellationToken);
    }
}
