...
{
    /// <summary>
    /// 微信公众平台专用域名(mp.weixin.qq.com)，使用该域名将访问官方指定的接入点；
    /// </summary>
    public const string MP = "mp.weixin.qq.com";
    
    /// <summary>
    /// 文件专用域名(file.api.weixin.qq.com)，使用该域名将访问官方指定的接入点；
    /// </summary>
    public const string File = "file.api.weixin.qq.com";
    ...
    public static IList<string> All
    {
        get
        {
            return new List<string> { Default, Backup, Shanghai, Shenzhen, Hongkong };
        }
    }
}
