...
[Obsolete("Please use WeixinExpirationRedisCacheProvider instead. This provider is NOT support 7.0 or above")]
public class WeixinExpirationRedisCacheProviderX<T> : IWeixinCacheProvider<T>
    where T : IWeixinExpirableValue, new()
{
    ...
    public WeixinExpirationRedisCacheProviderX(IDistributedCache cache)
    {
