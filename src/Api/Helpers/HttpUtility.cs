...
public static class HttpUtility
{
    ...
    public static async Task<T> PostGetXml<T>(string url, string xml)
    {
        ...
        var result = WeixinXmlConvert.DeserializeObject<T>(resultText);
        return result;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public static async Task<string> HttpPost(string url, CookieContainer cookieContainer = null, Dictionary<string, string> formData = null, Encoding encoding = null, int timeOut = HttpUtilityConfig.TIME_OUT)
    {
    ...
    /// </summary>
    /// <returns></returns>
    public static async Task<string> HttpPostXml(string url, string xml, Encoding encoding = null, int timeout = HttpUtilityConfig.TIME_OUT)
    {
    ...
    /// </summary>
    /// <returns></returns>
    public static async Task<string> HttpPostJson(string url, string json, Encoding encoding = null, int timeout = HttpUtilityConfig.TIME_OUT)
    {
        if (encoding == null) encoding = Encoding.UTF8;
    ...
    public static async Task<string> HttpPost(string url, CookieContainer cookieContainer = null,
        ...
        string refererUrl = null, Encoding encoding = null, int timeOut = HttpUtilityConfig.TIME_OUT)
    {
        var httpClient = new HttpClient();
        httpClient.Timeout = TimeSpan.FromMilliseconds(timeOut);
