...
/// </list>
/// </remarks>
public class WifiApi : SecureWeixinApiClient, IWifiApi
{
    public WifiApi(IOptions<WeixinOptions> optionsAccessor, IWeixinAccessTokenApi tokenProvider) : base(optionsAccessor, tokenProvider)
    {
    }
    ...
    public async Task<GetQrcodeResultJson> GetQrcode(string accessToken, GetQrcodeParam param, CancellationToken cancellationToken = default)
    {
        ...
        GetQrcodeResultJson result = await SecurePostFormAsJsonAsync<GetQrcodeResultJson>(url, formData);
        return result;
    }
    ...
    /// </summary>
    /// <returns>白名单</returns>
    public async Task<GetWhiteListResultJson> GetWhiteList(CancellationToken cancellationToken = default)
    {
        var pathAndQuery = "/wifi/getWhiteList.xhtml?access_token=ACCESS_TOKEN&format=json";
        var url = Options?.BuildWeixinApiUrl(pathAndQuery);

        GetWhiteListResultJson result = await SecureGetFromJsonAsync<GetWhiteListResultJson>(url);
        return result;
    }
    ...
    public async Task<SetApResultJson> SetApInfo(List<ApInfo> apInfos, CancellationToken cancellationToken = default)
    {
        ...
        SetApResultJson result = await SecurePostFormAsJsonAsync<SetApResultJson>(url, param);
        return result;
    }
    ...
    /// <returns></returns>
    public async Task<SetAdResultJson> SetAdInfo(Ad ad, CancellationToken cancellationToken = default)
    {
        ...
        SetAdResultJson result = await SecurePostFormAsJsonAsync<SetAdResultJson>(url, param);
        return result;
    }
    ...
    /// <returns></returns>
    public async Task<WifiErrorJson> NoticeWeixinInfo(string mac, NoticeWeixinInfoAction action = NoticeWeixinInfoAction.push, string deviceMac = null, CancellationToken cancellationToken = default)
    {
        ...
        WifiErrorJson result = await GetFromJsonAsync<WifiErrorJson>(url);
        return result;
    }
    ...
    public async Task<GetAuditStatusResultJson> GetAuditStatus(string requestId, CancellationToken cancellationToken = default)
    {
        var accessToken = await GetTokenAsync(cancellationToken);
        ...
        GetAuditStatusResultJson result = await GetFromJsonAsync<GetAuditStatusResultJson>(url);
        return result;
    }
    ...
    public async Task<GetApplyShopResultJson> GetApplyShop(DateTime applyDate, CancellationToken cancellationToken = default)
    {
        var accessToken = await GetTokenAsync(cancellationToken);
        ...
        GetApplyShopResultJson result = await GetFromJsonAsync<GetApplyShopResultJson>(url);
        return result;
    }
    ...
    /// </returns>
    public async Task<WifiErrorJson> PushStatData(DateTime statDate, List<DeviceStat> statList, CancellationToken cancellationToken = default)
    {
        ...
        WifiErrorJson result = await SecurePostFormAsJsonAsync<WifiErrorJson>(url, param);
        return result;
    }
    ...
    public async Task<GetPublishedAdResultJson> GetPublishedAd(string deviceNo, CancellationToken cancellationToken = default)
    {
        var accessToken = await GetTokenAsync(cancellationToken);
        ...
        GetPublishedAdResultJson result = await GetFromJsonAsync<GetPublishedAdResultJson>(url);
        return result;
    }
    ...
    /// </returns>
    public async Task<WifiErrorJson> SetVendorConfig(string callbackUrl, string callbackToken, CancellationToken cancellationToken = default)
    {
    ...
    /// <para><code>{"errorCode":40013,"errorMessage":"invalid appid"}</code></para>
    /// </returns>
    public async Task<WifiErrorJson> PushApOnline(List<ApOnlineData> apOnlineList, CancellationToken cancellationToken = default)
    {
    ...
    /// <para><code>{"errorCode":40013,"errorMessage":"invalid appid"}</code></para>
    /// </returns>
    public async Task<WifiErrorJson> BindAd(string adId, List<string> deviceNos, CancellationToken cancellationToken = default)
    {
