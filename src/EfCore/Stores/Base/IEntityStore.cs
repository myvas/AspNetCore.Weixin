    ...
    where TEntity : class, IEntity
{
    ...
    Task<WeixinResult> CreateAsync(TEntity entity, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
    /// <returns>A <see cref="Task{TResult}"/> that represents the <see cref="WeixinResult"/> of the asynchronous query.</returns>
    Task<WeixinResult> UpdateAsync(TEntity entity, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
    /// <returns>A <see cref="Task{TResult}"/> that represents the <see cref="WeixinResult"/> of the asynchronous query.</returns>
    Task<WeixinResult> DeleteAsync(TEntity entity, CancellationToken cancellationToken = default);
    ...
    Task<string> GetIdAsync(TEntity entity, CancellationToken cancellationToken = default);
