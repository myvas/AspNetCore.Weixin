...
/// <summary>
/// A <see cref="JsonConverter"/> which explicitly serializes the derived class properties after the base class properties.
/// </summary>
/// <typeparam name="T"></typeparam>
public class BaseClassFirstConverter<T> : JsonConverter<T>
    where T : class
{
    /// <inheritdoc />
