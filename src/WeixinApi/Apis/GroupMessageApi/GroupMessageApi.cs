...
namespace Myvas.AspNetCore.Weixin
{
    ...
    {
        public GroupMessageApi(IOptions<WeixinApiOptions> optionsAccessor, IWeixinAccessToken tokenProvider) : base(optionsAccessor, tokenProvider)
        {
        }
        ...
        /// <returns></returns>
        public async Task<SendResult> SendGroupMessageByGroupId(string accessToken, string groupId, string mediaId)
        {
            ...
            return await PostAsJsonAsync<object, SendResult>(accessToken, urlFormat, data);
        }
        ...
        /// <returns></returns>
        public async Task<SendResult> SendGroupMessageByOpenId(string accessToken, string mediaId, params string[] openIds)
        {
        ...
        /// <returns></returns>
        public async Task<WeixinErrorJson> DeleteSendMessage(string accessToken, string mediaId)
        {
