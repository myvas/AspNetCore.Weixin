...
namespace Myvas.AspNetCore.Weixin
{
    ...
    {
        public QrcodeApi(IOptions<WeixinApiOptions> optionsAccessor, IWeixinAccessToken tokenProvider) : base(optionsAccessor, tokenProvider)
        {
        }
