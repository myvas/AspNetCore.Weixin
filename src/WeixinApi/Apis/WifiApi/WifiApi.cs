...
namespace Myvas.AspNetCore.Weixin
{
    ...
    /// <remarks>
    /// <list type="">接口实现说明
    /// <item>接口1：已在公共接口(<see cref="WeixinAccessTokenApi"/>)中实现</item>
    ...
    {
        public WifiApi(IOptions<WeixinApiOptions> optionsAccessor, IWeixinAccessToken tokenProvider) : base(optionsAccessor, tokenProvider)
        {
        }
        ...
        public async Task<GetQrcodeResultJson> GetQrcode(string accessToken, GetQrcodeParam param)
        {
            ...
            GetQrcodeResultJson result = await PostFormAsJsonAsync<GetQrcodeResultJson>(api, formData);
            return result;
        }
        ...
        /// </summary>
        /// <returns>白名单</returns>
        public async Task<GetWhiteListResultJson> GetWhiteList(string accessToken)
        {
            string api = "https://api.weixin.qq.com/wifi/getWhiteList.xhtml?access_token=ACCESSTOKEN&format=json";
            api = api.Replace("ACCESSTOKEN", accessToken);

            GetWhiteListResultJson result = await GetFromJsonAsync<GetWhiteListResultJson>(api);
            return result;
        }
        ...
        public async Task<SetApResultJson> SetApInfo(string accessToken, List<ApInfo> apInfos)
        {
            ...
            SetApResultJson result = await PostFormAsJsonAsync<SetApResultJson>(api, param);
            return result;
        }
        ...
        /// <returns></returns>
        public async Task<SetAdResultJson> SetAdInfo(string accessToken, Ad ad)
        {
            ...
            SetAdResultJson result = await PostFormAsJsonAsync<SetAdResultJson>(api, param);
            return result;
        }
        ...
        /// <returns></returns>
        public async Task<WifiErrorJson> NoticeWeixinInfo(string accessToken, string mac, NoticeWeixinInfoAction action = NoticeWeixinInfoAction.push, string deviceMac = null)
        {
            ...
            WifiErrorJson result = await GetFromJsonAsync<WifiErrorJson>(api);
            return result;
        }
        ...
        public async Task<GetAuditStatusResultJson> GetAuditStatus(string accessToken, string requestId)
        {
            ...
            GetAuditStatusResultJson result = await GetFromJsonAsync<GetAuditStatusResultJson>(api);
            return result;
        }
        ...
        public async Task<GetApplyShopResultJson> GetApplyShop(string accessToken, DateTime applyDate)
        {
            ...
            GetApplyShopResultJson result = await GetFromJsonAsync<GetApplyShopResultJson>(api);
            return result;
        }
        ...
        /// </returns>
        public async Task<WifiErrorJson> PushStatData(string accessToken, DateTime statDate, List<DeviceStat> statList)
        {
            ...
            WifiErrorJson result = await PostFormAsJsonAsync<WifiErrorJson>(api, param);
            return result;
        }
        ...
        public async Task<GetPublishedAdResultJson> GetPublishedAd(string accessToken, string deviceNo)
        {
            ...
            GetPublishedAdResultJson result = await GetFromJsonAsync<GetPublishedAdResultJson>(api);
            return result;
        }
        ...
        /// </returns>
        public async Task<WifiErrorJson> SetVendorConfig(string accessToken, string callbackUrl, string callbackToken)
        {
        ...
        /// <para><code>{"errorCode":40013,"errorMessage":"invalid appid"}</code></para>
        /// </returns>
        public async Task<WifiErrorJson> PushApOnline(string accessToken, List<ApOnlineData> apOnlineList)
        {
        ...
        /// <para><code>{"errorCode":40013,"errorMessage":"invalid appid"}</code></para>
        /// </returns>
        public async Task<WifiErrorJson> BindAd(string accessToken, string adId, List<string> deviceNos)
        {
