...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static WeixinSiteBuilder AddEntityFrameworkCores<TWeixinDbContext>(this WeixinBuilder builder)
        ...
        public static WeixinSiteBuilder AddEntityFrameworkCores<TWeixinDbContext, TKey>(this WeixinBuilder builder)
            where TWeixinDbContext : DbContext
        ...
        public static WeixinSiteBuilder AddEntityFrameworkCores<TWeixinDbContext, TWeixinSubscriber, TKey>(this WeixinBuilder builder)
            where TWeixinDbContext : DbContext
