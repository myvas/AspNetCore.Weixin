...
public class VoiceMessageWeixinHandler : IWeixinHandler<VoiceMessageReceivedXml>
{
    private readonly ILogger _logger;
    private readonly IWeixinHandlerFactory _handlerFactory;
    private readonly WeixinSiteOptions _options;

    public VoiceMessageWeixinHandler(ILogger<WeixinHandler> logger,
    ...
    public async Task<bool> ProcessAsync()
    {
        ...
        var ctx = new WeixinReceivedContext<VoiceMessageReceivedXml>(Context, Text, Xml);
