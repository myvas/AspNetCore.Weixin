...
public class ImageMessageWeixinHandler : IWeixinHandler<ImageMessageReceivedXml>
{
    private readonly ILogger _logger;
    private readonly IWeixinHandlerFactory _handlerFactory;
    private readonly WeixinSiteOptions _options;

    public ImageMessageWeixinHandler(ILogger<WeixinHandler> logger,
    ...
    public async Task<bool> ProcessAsync()
    {
        ...
        var ctx = new WeixinReceivedContext<ImageMessageReceivedXml>(Context, Text, Xml);
