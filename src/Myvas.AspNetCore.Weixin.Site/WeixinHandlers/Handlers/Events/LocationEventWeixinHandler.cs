...
public class LocationEventWeixinHandler : IWeixinHandler<LocationEventReceivedXml>
{
    private readonly ILogger _logger;
    private readonly IWeixinHandlerFactory _handlerFactory;
    private readonly WeixinSiteOptions _options;

    public LocationEventWeixinHandler(ILogger<WeixinHandler> logger,
    ...
    public async Task<bool> ProcessAsync()
    {
        ...
        var ctx = new WeixinReceivedContext<LocationEventReceivedXml>(Context, Text, Xml);
