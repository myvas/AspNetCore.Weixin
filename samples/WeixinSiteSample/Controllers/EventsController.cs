...
public class EventsController : Controller
{
    ...
    private readonly IWeixinReceivedEventStore _store;

    public EventsController(IWeixinReceivedEventStore store, ILogger<EventsController> logger)
    {
    ...
    public async Task<IActionResult> Index(int? n)
    {
        ...
        // Create the model
        var model = new EntitiesViewModel<WeixinReceivedEventEntity>
        {
            Items = items,
            PageSize = pageSize,
